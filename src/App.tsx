...
function App() {
  ...
  const getPageMetadata = () => {
    switch (currentView) {
      case "new":
        return {
          title: "Create New Reflection - Mindful Journal",
          description:
            "Start your mindfulness journey by creating a new reflection. Share your thoughts, gratitude, and growth moments.",
        };
      case "edit":
        return {
          title: "Edit Reflection - Mindful Journal",
          description:
            "Update and refine your wellness reflection. Continue nurturing your mental health journey.",
        };
      case "dashboard":
        return {
          title: "Wellness Insights - Mindful Journal",
          description:
            "Track your wellness journey with insights and analytics. Celebrate your growth and self-care progress.",
        };
      default:
        return {
          title: "Mindful Journal - Your Wellness Companion",
          description:
            "A private, secure space for your mindfulness reflections. Track your mental health, gratitude, and personal growth.",
        };
    }
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:image"
          content="https://unsplash.com/photos/person-writing-on-a-book-fMD_Cru6OTk"
        />{" "}
